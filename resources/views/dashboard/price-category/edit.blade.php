                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.price-categories.update', $priceCategory->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $priceCategory->name }}">
                        </div>
                        ...
                        <div class="form-group">
                            <label><input type="checkbox" name="locale" @if($priceCategory->locale == 'ar') checked @endif> @lang('dashboard.arabic')</label>
                        </div>
